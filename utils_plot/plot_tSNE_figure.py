...
X_tsne = torch.load(f"tsne_ppl_{perplexity}.pt")
...
plt.savefig(f"tsne_ppl_{perplexity}_top10_label.png")
# Clear the current figure
plt.clf()
...
for text in legend.get_texts():
    text.set_fontsize('12')  # Adjust the legend text font size
# Save the scatterplot figure
plt.savefig(f"tsne_ppl_{perplexity}_15-vowel.png")
plt.clf()
...
for phonemes in desired_labels:
    ...
    for text in legend.get_texts():
        text.set_fontsize('12')  # Adjust the legend text font size
    # Save the scatterplot figure
    plt.savefig(f"tsne_ppl_{perplexity}_{phonemes[0][:-1]}_vowel.png")
    plt.clf()
...
for text in legend.get_texts():
    text.set_fontsize('12')  # Adjust the legend text font size
# Save the scatterplot figure
plt.savefig(f"tsne_ppl_{perplexity}_vowel_combined.png")
