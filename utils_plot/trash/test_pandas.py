...
# all_label = phonemes
# X = np.array(X)
# torch.save(X_raw_phoneme_representation, 'X_raw_phoneme_representation.pt')
...
X_tsne = torch.load("tsne_ppl_30_val.pt")
phonemes = torch.load('phonemes_ppl_30_val.pt')
df = pd.DataFrame()
...
unique_labels = df['phonemes'].unique()
# print(unique_labels)
# print(len(unique_labels))
unique_labels_list = unique_labels.tolist()
unique_labels_sorted = sorted(unique_labels_list)
print(unique_labels_sorted)
print(len(unique_labels_sorted))
